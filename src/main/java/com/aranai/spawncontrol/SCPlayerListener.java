...
public class SCPlayerListener extends PlayerListener {
    ...
    public boolean isExemptFromCooldowns(Player p, String cooldown)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.CooldownExempt."+cooldown);
    	}
    ...
    public boolean canUseSpawn(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.spawn.use");
    	}
    ...
    public boolean canUseSetSpawn(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.spawn.set");
    	}
    ...
    public boolean canUseSetGroupSpawn(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.groupspawn.set");
    	}
    ...
    public boolean canUseGroupSpawn(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.groupspawn.use");
    	}
    ...
    public boolean canUseHomeBasic(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.home.basic");
    	}
    ...
    public boolean canUseSetHomeBasic(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.sethome.basic");
    	}
    ...
    public boolean canUseSetHomeProxy(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.sethome.proxy");
    	}
    ...
    public boolean canUseScConfig(Player p)
    {
    	if(plugin.usePermissions)
    	{
    		return plugin.permissionHandler.has(p, "SpawnControl.config");
    	}
